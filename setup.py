...
setuptools.setup(
	...
	data_files=[
        ...
        (
            'share/tbprofiler/tbdb/snpeff/data/Mycobacterium_tuberculosis_h37rv_tbprofiler',
            [x for x in glob("db/tbdb/snpeff/data/Mycobacterium_tuberculosis_h37rv_tbprofiler/*") if not os.path.isdir(x)]
        ),
        (
            'share/tbprofiler/',
